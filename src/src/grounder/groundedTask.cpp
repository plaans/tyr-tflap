...
string GroundedNumericExpression::toString(ParsedTask* task, vector<GroundedVar> &variables) {
    string s;
    switch (type) {
...
string GroundedNumericCondition::toString(ParsedTask* task, vector<GroundedVar> &variables) {
...
string GroundedNumericEffect::toString(ParsedTask* task, vector<GroundedVar> &variables) {
...
string GroundedDuration::toString(ParsedTask* task, vector<GroundedVar> &variables) {
    string s = "(";
    bool closePar = false;
    if (time == AT_END) {
       s += "at end (";
