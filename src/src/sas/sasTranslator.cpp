...
#include "sasTranslator.hpp"
#include "../parser/parsedTask.hpp"
...
void SASTranslator::generateEffect(vector<GroundedCondition>* effects, unsigned int effIndex, SASTask* sTask, LiteralTranslation* trans, vector<SASCondition>* conditionSet) {
	unsigned int sasVar, sasValue, code;
...
SASNumericCondition SASTranslator::generateNumericCondition(GroundedNumericCondition* cond, LiteralTranslation* trans) {
