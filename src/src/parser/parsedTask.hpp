...
enum NumericExpressionType {NET_NUMBER = 0, NET_FUNCTION = 1, NET_NEGATION = 2, 
...
public:
    ...
    std::string toString(const std::vector<Variable> &parameters, const std::vector<Function> &functions,
...
enum Comparator {CMP_EQ = 0, CMP_LESS = 1, CMP_LESS_EQ = 2, CMP_GREATER = 3,
...
enum GoalDescriptionType {GD_LITERAL = 0, GD_AND = 1, GD_NOT = 2, GD_OR = 3,
...
public:
    ...
    std::string toString(const std::vector<Variable> &opParameters, const std::vector<Function> &functions,
        const std::vector<Object> &objects, const std::vector<Type> &taskTypes);
};
...
enum EffectExpressionType {EE_NUMBER = 0, EE_DURATION = 1, EE_TERM = 2,
...
enum Assignment {AS_ASSIGN = 0, AS_INCREASE = 1, AS_DECREASE = 2, AS_SCALE_UP = 3, 
    AS_SCALE_DOWN = 4};
...
enum TimedEffectType {TE_AND = 0, TE_NOT = 1, TE_LITERAL = 2, TE_ASSIGNMENT = 3,
...
enum DurativeEffectType {DET_AND = 0, DET_TIMED_EFFECT = 1, DET_FORALL = 2, DET_WHEN = 3,
    DET_ASSIGNMENT = 4};
...
enum PreconditionType {PT_LITERAL = 0, PT_AND = 1, PT_NOT = 2, PT_OR = 3,
...
enum EffectType {ET_LITERAL = 0, ET_AND = 1, ET_NOT = 2, ET_FORALL = 3,
...
enum MetricExpressionType {MT_PLUS = 0, MT_MINUS = 1, MT_PROD = 2, MT_DIV = 3,
...
enum ConstraintType {RT_AND = 0, RT_FORALL = 1, RT_PREFERENCE = 2, RT_AT_END = 3,
